      ...
      <el-form autoComplete="on" :model="loginForm" ref="loginForm" label-position="left" label-width="0px"
        class="card-box login-form">
          <el-form-item prop="loginName">
            <i class='ico1'></i>
            <el-input name="loginName" auto-complete="new-text" type="text" id="text" v-model="loginForm.loginName" placeholder="用户名" @keyup.enter.native="handleLogin('loginForm')"></el-input>
          </el-form-item>
          <el-form-item prop="pwd">
            <i class='ico2'></i>
            <el-input name="pwd" auto-complete="new-password" :type="passwordType" v-model="loginForm.pwd" placeholder="密码" @keyup.enter.native="handleLogin('loginForm')"></el-input>
          ...
          <span class="svg-container"  @click="changeImgUrl">
            ...
            <!-- <span class="inline-span">China</span> -->
        </el-form-item>
