<template>
  <div>
    <!--查询表单-->
    <search-com :labelWidth="'100px'" :searchData="searchData" ref="searchMX" :formData="qc"
...
export default {
  ...
  methods: {
    ...
    query(pageNum, pageSize) {
      ...
      this.$axios_http({
        url: "/base/rxxx/query/getRxxxListByCondition",
    ...
    pageSizeChange(pageSize) {
      this.qc = this.getFormData("searchMX");
    ...
    getCount() {
      this.$axios_http({
        url: "/base/rxxx/find/rxxxCountNum",
        data: {
