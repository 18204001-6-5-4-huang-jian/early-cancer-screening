<template>
  <div>
    <!--查询表单-->
    <search-com :labelWidth="'100px'" :searchData="searchData" :formData="qc" ref="searchMsound"
            ...
            <template slot="operating">
              ...
              >
                <template slot-scope="scope">
                  ...
                  <el-button type="text" size="small" v-if="scope.row.reportInputStatus==3" @click="generateReport(scope.row)">生成报告</el-button>
...
import { MSOUND } from "./searchConfig";
...
export default {
  data() {
    return {
      ...
      screeningResult: DICTIONARY.mammaryScreeningResult, //筛查结果
  ...
  methods: {
    ...
    query() {
      ...
      this.$axios_http({
        url: "/base/rxcs/query/getRxcsListByCondition",
    ...
    pageSizeChange(pageSize) {
      this.qc = this.getFormData("searchMsound");
    ...
    getCount() {
      this.$axios_http({
        url: "/base/rxcs/find/rxcsCountNum",
        data: {
