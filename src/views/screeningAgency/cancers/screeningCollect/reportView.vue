<template>
        <cancer-widget>
            <div class="screeningCollectView">
                ...
                <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
                    ...
                    <el-tab-pane :label="title+'结果报告'" name="1" v-if="$route.query.reportId != '' && $route.query.reportId != null">
                        ...
                        <el-form :model="personDetail" label-width="130px" ref="screeningCollectView" :inline="true"  class="demo-screeningCollectView">
                        <el-row>
                            <el-col :span="8">
