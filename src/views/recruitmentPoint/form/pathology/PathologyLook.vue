                ...
                <el-form :model="form" :rules="formRules" ref="form" class="demo-form" :inline="true">
                    ...
                    <div>
                        ...
                        <el-row>
                            <el-form-item label="5. 高级别上皮内瘤变比例（%）:" style="margin-bottom:0;margin-right: 0;" :prop="'pathologyDiagnosisRecordPOList.'+index+'.item5'" :rules="lesionsRecordListRules.item5">
                                <el-input disabled v-model="x.item5" size="small" style="width:82px;"></el-input>
                            </el-form-item>
                        </el-row>
                        <el-row>
                            <el-form-item label="6. 腺瘤性息肉管状比例（%）:" style="margin-bottom:0;margin-right: 0;" :prop="'pathologyDiagnosisRecordPOList.'+index+'.item61'" :rules="lesionsRecordListRules.item61">
                                <el-input disabled v-model="x.item61" size="small" style="width:82px;"></el-input>
                            </el-form-item>
                        </el-row>
                        <el-row>
                            <el-form-item label="7. 腺瘤性息肉绒毛状比例（%）:"  :prop="'pathologyDiagnosisRecordPOList.'+index+'.item62'" :rules="lesionsRecordListRules.item62">
                                <el-input disabled v-model="x.item62" size="small" style="width:82px;"></el-input>
                            </el-form-item>
                        </el-row>
                        <el-row>
                            <el-form-item label="8. 备注:"  class="blockTit">
                                <el-input disabled v-model="x.item7" type="textarea" :autosize="{minRows:3}" style="width: 100%;min-width: 500px;margin-left:18px;"></el-input>
                            </el-form-item>
                        </el-row>
                    </div>
                    </div>
                    ...
                    <el-row>
                        <el-form-item label="1.是否需要国家癌症中心会诊（复阅）？" prop="item1">
                            <el-radio-group disabled v-model="form.item1">
                    ...
                    <el-row>
                        <el-form-item label="2.是否诊断为结直肠癌前病变：" prop="item2">
                            <el-radio-group disabled v-model="form.item2">
                                <el-radio :label="1">1.是</el-radio>
                                <el-radio :label="2">2.否</el-radio>
                            </el-radio-group>
                        </el-form-item>
                    ...
                    <el-row>
                        <el-form-item label="3.是否诊断为结直肠癌：" prop="item3">
                            <el-radio-group disabled v-model="form.item3">
                                <el-radio :label="1">1.是</el-radio>
                                <el-radio :label="2">2.否</el-radio>
                            </el-radio-group>
                        </el-form-item>
                    ...
                    <el-row>
                        ...
                        <el-col :span="12">
                            <el-form-item label="医师签名："  prop="inputUser">
                                <el-input disabled v-model="form.inputUser"  size="mini"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                </el-form>
                <div class="btns" v-if="$route.query.source!='gj' && $route.query.pathologyReportEnterStatus!=1" style="text-align:center;margin-top:50px;padding-top:15px;border-top:1px dashed #dcdfe6;">
                    <router-link :to="{path:'/form/pathologyentry',query:{
...
<script>
    ...
    export default {
        mixins: [getPersonDetail,getPathologyForm],
        data() {
        ...
        methods: {
            ...
            submitCTResult(type){
                ...
                this.form.pathologyDiagnosisRecordPOList.filter(item => {
                   item.item4 = item.item4.toString()
                })
                this.$axios_http({
