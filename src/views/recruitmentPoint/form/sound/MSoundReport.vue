    ...
    <div>
        <div class="reportBox">
            <cancer-widget>
                ...
                <div id="print">
                    <h1 style="text-align: center;">乳腺超声报告</h1>
                    ...
                    <el-form :model="form" :rules="formRules" ref="form" class="demo-form">
                        ...
                        <div class="block">
                            <el-row>
                                <el-form-item label="" prop="ultrasonicDescribe" class="blockTit">
                                    <el-input :disabled="$route.query.flag==0" v-model="form.ultrasonicDescribe"
                        ...
                        <div class="block">
                            <el-row>
                                <el-form-item label="" prop="ultrasonicPrompt" class="blockTit">
                                    <el-input :disabled="$route.query.flag==0" v-model="form.ultrasonicPrompt"
                                              type="textarea" :autosize="{minRows:4}"></el-input>
                                </el-form-item>
                            </el-row>
                        </div>
                        <el-row>
                            <el-form-item label="报告医师" labelWidth="80px" prop="reportDoctor" class="inline">
                                <el-input :disabled="$route.query.flag==0" v-model.trim="form.reportDoctor" size="mini"
                                          style="width: 200px;"></el-input>
                            </el-form-item>
                        </el-row>
                        <el-row>
                            <el-form-item label="审核医师" labelWidth="80px" prop="checkDoctor" class="inline">
                                <el-input :disabled="$route.query.flag==0" v-model.trim="form.checkDoctor" size="mini"
                                          style="width: 200px;"></el-input>
                            </el-form-item>
                        </el-row>
                    </el-form>
    ...
    export default {
        ...
        data() {
            return {
                ...
                form: {
                    reportNum: null,
                    ultrasonicDescribe: null,
                    ultrasonicPrompt: null,
                    checkDoctor: null,
        ...
        methods: {
            ...
            queryReport() {
                this.$axios_http({
                    url: '/base/rxcs/get/rxcsReportById',
            ...
            submitForm() {
                this.$refs.form.validate((valid, obj) => {
                    if (valid) {
                        this.$axios_http({
                            url: '/base/rxcs/update/rxcsReport',
                            data: {
                                inputStatus: 1,
                                ...
                                ultrasonicDescribe: this.form.ultrasonicDescribe,
                                ultrasonicPrompt: this.form.ultrasonicPrompt,
