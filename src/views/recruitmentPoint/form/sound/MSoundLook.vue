       ...
       <h1>乳腺超声结果记录表</h1>
          ...
          <h2>乳腺体形态</h2>
            ...
            <el-row>
              <el-form-item label="2.左侧乳腺实质厚度（cm）" prop="item12">
                <el-input disabled v-model.trim="form.item12" size="mini" placeholder="请输入左侧乳腺实质厚度：" clearable></el-input>
              </el-form-item>
              <el-form-item label="左侧乳腺厚度（cm）" prop="item13" class="cancer-margin--l20">
                <el-input disabled v-model.trim="form.item13" size="mini" placeholder="请输入左侧乳腺厚度：" clearable></el-input>
              </el-form-item>
               <el-form-item label="左侧乳腺比值" prop="item14" class="cancer-margin--l20">
                <el-radio-group disabled v-model="form.item14">
                  <el-radio
            ...
            <el-row>  
              <el-form-item label="3.右侧乳腺实质厚度（cm）" prop="item15">
                <el-input disabled v-model.trim="form.item15" size="mini" placeholder="请输入右侧乳腺实质厚度：" clearable></el-input>
              </el-form-item>
               <el-form-item label="右侧乳腺厚度（cm）" prop="item16" class="cancer-margin--l20">
                <el-input disabled v-model.trim="form.item16" size="mini" placeholder="请输入右侧乳腺厚度：" clearable></el-input>
              </el-form-item>
               <el-form-item label="右侧乳腺比值" prop="item17" class="cancer-margin--l20">
                <el-radio-group disabled v-model="form.item17">
                  <el-radio
            ...
            <el-row>
              <el-form-item label="4.腺体结构" prop="item18">
                <el-radio-group disabled v-model="form.item18" class="redio18">
                  <el-radio
        ...
        <el-row v-if="form.item21==1">
          <el-form-item label="1.1探及占位个数" prop="item22" class="cancer-margin--l20">
            <el-input disabled v-model.trim="form.item22" size="mini" placeholder="请输入探及占位个数：" clearable @blur="tuberChange(form.item22)"></el-input>
          </el-form-item>
           <el-form-item v-if="form.item21==1" label="左个数" prop="item23" class="cancer-margin--l20">
            <el-input disabled v-model.trim="form.item23" size="mini" placeholder="请输入左个数：" clearable></el-input>
          </el-form-item>
           <el-form-item v-if="form.item21==1" label="右个数" prop="item24" class="cancer-margin--l20">
            <el-input disabled v-model.trim="form.item24" size="mini" placeholder="请输入右个数：" clearable></el-input>
          </el-form-item>
        </el-row>
        <!--乳腺超声结果乳腺分型与超声诊断表占位表-->
        <el-row v-for="(x,index) in form.hosRxcsResultOccupyInfoPOS" :key="index" v-if="form.item21==1">
          ...
          <el-form :inline="true" :model="x" :ref="'hosRxcsInfo'+index" :rules="hosRxcshRules">
            ...
            <!-- <el-row>
              <el-form-item label="2.1.占位象限点:" prop="item21">
                <el-input disabled v-model.trim="x.item21"  size="mini"  clearable></el-input>
              </el-form-item>
            </el-row> -->
            ...
            <el-row>
              <el-form-item label="3.占位位置距乳头距离（cm）:" prop="item3">
                <el-input disabled v-model.trim="x.item3" size="mini"  clearable></el-input>
              </el-form-item>
            </el-row>
            <el-row>
            ...
            <el-row v-if="form.item21==1&&x.item9==2||x.item9==3||x.item9==4">
              <el-form-item label="9.1占位内中回声均匀：" prop="item91" class="cancer-margin--l20">
                <el-radio-group disabled v-model="x.item91">
                  <el-radio
            ...
            <el-row v-if="form.item21==1&&x.item9==2||x.item9==3||x.item9==4">
              <el-form-item label="9.2占位内回声中强回声光点：" prop="item92" class="cancer-margin--l20">
                <el-radio-group disabled v-model="x.item92">
                  <el-radio
            ...
            <el-row v-if="form.item21==1&&x.item9==2||x.item9==3||x.item9==4">
              <el-form-item label="9.3占位内回声中强回声光团：" prop="item93" class="cancer-margin--l20">
                <el-radio-group disabled v-model="x.item93">
                  <el-radio
            ...
            <el-row v-if="form.item21==1&&x.item9==2||x.item9==3||x.item9==4">
              <el-form-item label="9.4占位内回声中无回声区：" prop="item94" class="cancer-margin--l20">
                <el-radio-group disabled v-model="x.item94">
                  <el-radio
            ...
            <el-row v-if="form.item21==1&&x.item9==2||x.item9==3||x.item9==4">
              <el-form-item label="9.5占位内回声中结节或肿物后方回声：" prop="item95" class="cancer-margin--l20">
                <el-radio-group disabled v-model="x.item95">
                  <el-radio
            ...
            <el-row v-if="form.item21==1&&x.item9==2||x.item9==3||x.item9==4">
              <el-form-item label="9.6占位内回声中侧方声影：" prop="item96" class="cancer-margin--l20">
                <el-radio-group disabled v-model="x.item96">
                  <el-radio
            ...
            <el-row v-if="form.item21==1 && x.item9!=1 && x.item10==2">
              <el-form-item label="10.1 血流信息是否丰富？：" prop="item101" class="cancer-margin--l20">
                <el-radio-group disabled v-model="x.item101">
                  <el-radio
            ...
            <el-row v-if="form.item21==1 && x.item9!=1 && x.item10==2">
              <el-form-item label="10.2CDFI血流：RI值是多少？：" prop="item102" class="cancer-margin--l20">
                <el-input disabled v-model.trim="x.item102" size="mini"  clearable></el-input>
              </el-form-item>
            </el-row>
          </el-form>
        </el-row>
        ...
        <h2>腋下肿大淋巴结</h2>
          ...
          <el-row v-if="form.item31==1">
            <el-form-item label="1.1腋下肿大淋巴结的个数？" prop="item32" class="cancer-margin--l20">
              <el-input disabled v-model.trim="form.item32" size="mini" placeholder="请输入腋下肿大淋巴结的个数：" clearable></el-input>
            </el-form-item>
            <el-form-item v-if="form.item31==1" label="左个数" prop="item33" class="cancer-margin--l20">
              <el-input disabled v-model.trim="form.item33" size="mini" placeholder="请输入左个数：" clearable></el-input>
            </el-form-item>
            <el-form-item v-if="form.item31==1" label="右个数" prop="item34" class="cancer-margin--l20">
              <el-input disabled v-model.trim="form.item34" size="mini" placeholder="请输入右个数：" clearable></el-input>
            </el-form-item>
          </el-row>
            <el-row v-if="form.item31==1" style="margin-left:2px;" class="clearfix">
              <span style="color:#333" class="spanTit">1.2最大的尺寸，</span>
              <el-form-item label="长（厘米）" prop="item35">
                <el-input disabled v-model.trim="form.item35" size="mini" clearable></el-input>
              </el-form-item>
              <el-form-item label="宽（厘米）" prop="item36">
                <el-input disabled v-model.trim="form.item36" size="mini" clearable></el-input>
              </el-form-item>
            </el-row>
            <el-row v-if="form.item31==1">
            <el-form-item label="2. 腋下肿大淋巴结有无淋巴结门?" prop="item37">
              <el-radio-group disabled v-model="form.item37" class="redio37">
                <el-radio
          ...
          <el-row v-if="form.item37==2 && form.item31==1">
            <el-form-item label="2.1腋下肿大淋巴结淋巴结门位置？" prop="item38" class="cancer-margin--l20" label-width="276px">
              <el-radio-group disabled v-model="form.item38">
                <el-radio
          ...
          <el-row v-if="form.item31==1">
            <el-form-item label="3.有无CDFI血流：血流信号？" prop="item39">
              <el-radio-group disabled v-model="form.item39" class="redio39">
                <el-radio
          ...
          <el-row v-if="form.item39==2 && form.item31==1">
            <el-form-item label="3.1血流信息是否丰富？" prop="item310" class="cancer-margin--l20">
              <el-radio-group disabled v-model="form.item310" class="redio310">
                <el-radio
          ...
          <el-row v-if="form.item39==2 && form.item31==1">
            <el-form-item label="3.2血流信息表现" prop="item3101" class="cancer-margin--l20">
              <el-radio-group disabled v-model="form.item3101" class="redio3101">
                <el-radio
          ...
          <el-row v-if="form.item39==2 && form.item31==1">
            <el-form-item label="3.3CDFI血流：RI值是多少？" prop="item311"  class="cancer-margin--l20">
              <el-input disabled v-model.trim="form.item311" size="mini" placeholder="请输入CDFI血流：" clearable></el-input>
            </el-form-item>
          </el-row>
          <h2>乳腺分型</h2>
          <el-row>
            <el-form-item label="1.乳腺分型属于哪种类型？：" prop="breastType">
              <el-radio-group disabled v-model="form.breastType" class="rediobreastType">
                <el-radio
            ...
            <el-form :inline="true" :model="x" :ref="'diagnosisInfo'+index" :rules="diagnosisInfoRules">
              <el-row v-if="form.item21==1">
                <el-form-item :label='"1.占位"+(index+1)+"的超声诊断属于哪种？:"' prop="diagnosisType" class="blockTit">
                  <el-checkbox-group disabled v-model="x.diagnosisType">
                    <el-checkbox
              ...
              <el-row v-if="form.item21==1&&x.diagnosisType&&x.diagnosisType.includes(11)">
                <el-form-item label="1.1请输入其他诊断描述:" prop="otherDiagnosisDescribe" class="cancer-margin--l20">
                    <el-input disabled v-model.trim="x.otherDiagnosisDescribe" size="mini"  clearable></el-input>
                </el-form-item>
              </el-row>
              <el-row v-if="form.item21==1&&x.diagnosisType&&x.diagnosisType.includes(4)">
                <el-form-item label="1.2若乳导管扩张无占位，请输入大小（mm）:" prop="milkDuctSize" class="cancer-margin--l20">
                    <el-input disabled v-model.trim="x.milkDuctSize" size="mini"  clearable></el-input>
                </el-form-item>
              </el-row>
              <el-row v-if="form.item21==1">
                <el-form-item :label='"2.占位"+(index+1)+"按BI-RADS分类，属于哪一种？"' prop="biRads">
                  <el-checkbox-group disabled v-model="x.biRads">
                    <el-checkbox
         ...
         <div>
          ...
          <el-row class="no-margin-top">
             <el-form-item label="1. 病变的超声诊断属于哪种？" prop="item4" :rules="form.item21==1?[]:formRules.item4">
              <el-checkbox-group disabled v-model="form.item4">
                <el-checkbox
          ...
          <el-row v-if="form.item4.includes(1)">
            <el-form-item label="1.1 乳导管扩张为：" prop="item41" :rules="form.item21==1?[]:formRules.item41">
                <el-input disabled v-model.trim="form.item41" size="mini" clearable></el-input> mm
            </el-form-item>
          </el-row>
          <el-row v-if="form.item4.includes(2)">
            <el-form-item label="1.2 其他具体诊断为：" prop="item42" :rules="form.item21==1?[]:formRules.item42">
                <el-input disabled type="textarea" v-model.trim="form.item42" size="mini" clearable></el-input>
            </el-form-item>
          </el-row>

          <el-row class="no-margin-top">
             <el-form-item label="2. 按BI-RADS分类，该诊断属于：" prop="item5" :rules="form.item21==1?[]:formRules.item5">
              <el-checkbox-group disabled v-model="form.item5">
                <el-checkbox
        ...
        <div class="btns">
           <router-link v-if="$route.query.source!='gj' && $route.query.reportInputStatus!=1" :to="{path:'/form/mammaryultrasound',query:{
  ...
  export default {
    ...
    data() {
      return {
        ...
        formRules: {
          ...
          item13: [
            { required: true, message: '必填', trigger: 'blur' },
            { trigger: 'blur', validator: VALIDATE.count60}
          ],
        ...
        diagnosisInfoRules: {
          ...
          otherDiagnosisDescribe: [{ required: true, message: '必填', trigger: 'blur' }],
          milkDuctSize: [
            { required: true, message: '必填', trigger: 'blur' },
            { trigger: 'blur', validator: VALIDATE.countFloat50}
          ],
    ...
    methods: {
      ...
      submitForm(status) {
        if (status === 1) {
          ...
          for(var i=0;i<this.form.hosRxcsResultOccupyInfoPOS.length;i++){
            console.log(this.$refs['hosRxcsInfo'+i])
            this.$refs['hosRxcsInfo'+i] && this.$refs['hosRxcsInfo'+i][0].validate((valid) => {
              if (!valid){
                validFlag = false
              }
            })
          ...
          for(var j=0;j<this.form.hosRxcsResultOccupyDiagnosisInfoPOS.length;j++){
            this.$refs['diagnosisInfo'+j] && this.$refs['diagnosisInfo'+j][0].validate((valid) => {
              if (!valid){
                validFlag = false
              }
            })
      ...
      submitData (status) {
        ...
        params.filter((item) => {
            item.diagnosisType = item.diagnosisType && item.diagnosisType.length?item.diagnosisType.join(','):null
            item.biRads = item.biRads&&item.biRads.length?item.biRads.join(','):null
            item.item4 = item.item4&&item.item4.length?item.item4.join(','):null
            item.item5 = item.item5&&item.item5.length?item.item5.join(','):null
        })
        this.$axios_http({
...
.mammary-sound .el-radio__input.is-disabled.is-checked+span.el-radio__label {
    color: #409EFF;
  }
  .mammary-sound .el-radio__input.is-disabled.is-checked .el-radio__inner {
    background-color: #409EFF;
    border-color: #409EFF;
  }
  .mammary-sound .el-radio__input.is-disabled.is-checked .el-radio__inner::after {
    background-color: #f5f7fa;
  }
  .mammary-sound .el-input.is-disabled .el-input__inner {
    background-color: #fff;
    border-color: #dcdfe6;
    color: #606266;
    cursor: not-allowed;
  }
  .mammary-sound .el-input.is-disabled.grayInput .el-input__inner{
    background:#ededed;
  }
  .mammary-sound .el-textarea.is-disabled .el-textarea__inner {
    background-color: #fff;
    border-color: #dcdfe6;
    color: #606266;
    cursor: not-allowed;
  }
  .mammary-sound .el-checkbox__input.is-disabled.is-checked+span.el-checkbox__label {
    color: #409EFF;
    cursor: not-allowed;
  }
  .mammary-sound .el-checkbox__input.is-disabled.is-checked .el-checkbox__inner {
    background-color: #409EFF;
    border-color: #409EFF;
  }
  .mammary-sound .el-checkbox__input.is-disabled.is-checked .el-checkbox__inner::after {
    border-color: #fff;
  }
</style>