          ...
          <h2>检查基本信息</h2>
            <el-row>
              <el-form-item label="1.X线检查体位是？" prop="item1">
                <el-checkbox-group v-model="form.item1"  @change="changeItem1">
                  <el-checkbox
                    v-for="item in item1"
                    :key="item.key"
              ...
              <el-form-item label="1.2屏胶系统位置？" prop="item12" class="cancer-margin--l20" v-if="form.item1.includes(1)">
                <el-radio-group v-model="form.item12">
                  <el-radio
              ...
              <el-form-item label="1.3附加体位投照位置？" prop="item13" class="cancer-margin--l20" v-if="form.item1.includes(2)">
                <el-radio-group v-model="form.item13">
                  <el-radio
            ...
            <!-- <el-row> -->
              <el-form-item label="2.X线检查适应症？" prop="item2">
                <!-- <el-checkbox-group v-model="form.item2" @change="clearItem(form.item2,['item21'],2)">
                  <el-checkbox
                    v-for="item in item2"
                    :key="item.key"
                    :label="item.key">{{item.name}}</el-checkbox>
                ...
                <!-- 多选改单选 -->
                 <el-radio-group v-model="form.item2" @change="clearItem(form.item2,['item21'],2)">
                  <el-radio
                    v-for="item in item2"
                    :key="item.key"
                    :label="item.key">{{item.name}}</el-radio>
              ...
              <el-form-item label="2.1超声可疑发现 " prop="item21" class="cancer-margin--l20" v-if="form.item2 == '2'">
                <el-radio-group v-model="form.item21">
                  <el-radio
            ...
            <!-- <el-row> -->
              <el-form-item label="3.影像评估时是否结合既往乳腺影像资料（胶片，报告）" prop="item3">
                <el-radio-group v-model="form.item3" @change="clearItem(form.item3,['item31'],2)">
                  <el-radio
                    v-for="item in item3"
                    :key="item.key"
                    :label="item.key">{{item.name}}</el-radio>
              ...
              <el-form-item label="3.1既往资料距今距离多少？" prop="item31" class="cancer-margin--l20" v-if="form.item3 == 2">
                <el-radio-group v-model="form.item31">
                  <el-radio
            ...
            <!-- <el-row> -->
              <el-form-item label="4.乳腺实质BI-RADS 类型属于以下哪种？" prop="item41">
                <!-- <el-checkbox-group v-model="form.item41">
                  <el-checkbox
                    v-for="item in item41"
                    :key="item.key"
                    :label="item.key">{{item.name}}</el-checkbox>
                </el-checkbox-group> -->
                 <el-radio-group v-model="form.item41">
                  <el-radio
                    v-for="item in item41"
                    :key="item.key"
                    :label="item.key">{{item.name}}</el-radio>
        ...
        <el-form :model="hosRxxxResultImageDiscoveryInfoPOS[0]" :rules="leftRules" ref="leftRules">
          <el-row class="discover">
            <el-form-item label="1.左乳影像结果有无异常？ " prop="item1">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[0].item1" 
            ...
            <el-form-item label="2.左乳影像结果有无肿块？" prop="item2" v-if="hosRxxxResultImageDiscoveryInfoPOS[0].item1==2">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[0].item2" @change="clearItem(hosRxxxResultImageDiscoveryInfoPOS[0].item2,['item21','item22','item23','item24','item25','item26','item27','item28'],3)">
                <el-radio
            ...
            <el-form-item label="2.1肿块的形态？" prop="item21" v-if="hosRxxxResultImageDiscoveryInfoPOS[0].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[0].item2==2" class="cancer-margin--l20">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[0].item21">
                <el-radio
            ...
            <el-form-item label="2.2肿块的边缘？" prop="item22" v-if="hosRxxxResultImageDiscoveryInfoPOS[0].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[0].item2==2" class="cancer-margin--l20">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[0].item22">
                <el-radio
            ...
            <el-form-item label="2.3肿块的密度？" prop="item23" v-if="hosRxxxResultImageDiscoveryInfoPOS[0].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[0].item2==2" class="cancer-margin--l20">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[0].item23">
                <el-radio
            ...
            <el-form-item label="2.4肿块的最大径？" prop="item24" v-if="hosRxxxResultImageDiscoveryInfoPOS[0].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[0].item2==2" class="cancer-margin--l20">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[0].item24">
                <el-radio
            ...
            <el-form-item label="2.5肿块的象限？" prop="item25" v-if="hosRxxxResultImageDiscoveryInfoPOS[0].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[0].item2==2" class="cancer-margin--l20">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[0].item25">
                <el-radio
            ...
            <el-form-item label="2.6肿块的钟点？" prop="item26" v-if="hosRxxxResultImageDiscoveryInfoPOS[0].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[0].item2==2" class="cancer-margin--l20">
              <el-input v-model="hosRxxxResultImageDiscoveryInfoPOS[0].item26" size="small" clearable></el-input>
            </el-form-item>
            <el-form-item label="2.7肿块的深度？" prop="item27" v-if="hosRxxxResultImageDiscoveryInfoPOS[0].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[0].item2==2" class="cancer-margin--l20">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[0].item27">
                <el-radio
            ...
            <el-form-item label="2.8肿块距乳头距离？（cm）" prop="item28" v-if="hosRxxxResultImageDiscoveryInfoPOS[0].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[0].item2==2" class="cancer-margin--l20">
              <el-input v-model="hosRxxxResultImageDiscoveryInfoPOS[0].item28" v-numberInt:2="hosRxxxResultImageDiscoveryInfoPOS[0].item28" size="small" clearable></el-input>
            </el-form-item>
            <el-form-item label="3.左乳影像结果有无钙化？" prop="item3" v-if="hosRxxxResultImageDiscoveryInfoPOS[0].item1==2">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[0].item3" 
              @change="clearItem(hosRxxxResultImageDiscoveryInfoPOS[0].item3,['item31','item31A','item32','item33','item34','item35','item36','item37'],3)">
                <el-radio
            ...
            <el-form-item label="3.1钙化类型" prop="item31" 
            v-if="hosRxxxResultImageDiscoveryInfoPOS[0].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[0].item3==2" class="cancer-margin--l20">
              <el-checkbox-group v-model="hosRxxxResultImageDiscoveryInfoPOS[0].item31" @change="clearItem31(hosRxxxResultImageDiscoveryInfoPOS[0].item31,0)">
                <el-checkbox
            ...
            v-if="hosRxxxResultImageDiscoveryInfoPOS[0].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[0].item3==2 && hosRxxxResultImageDiscoveryInfoPOS[0].item31.includes(1)" class="cancer-margin--l20">
              <el-checkbox-group v-model="hosRxxxResultImageDiscoveryInfoPOS[0].item31A">
                <el-checkbox
            ...
            v-if="hosRxxxResultImageDiscoveryInfoPOS[0].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[0].item3==2 && hosRxxxResultImageDiscoveryInfoPOS[0].item31.includes(2)" class="cancer-margin--l20">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[0].item32">
                <el-radio
            ...
            v-if="hosRxxxResultImageDiscoveryInfoPOS[0].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[0].item3==2 && hosRxxxResultImageDiscoveryInfoPOS[0].item31.includes(2)" class="cancer-margin--l20">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[0].item33">
                <el-radio
            ...
            v-if="hosRxxxResultImageDiscoveryInfoPOS[0].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[0].item3==2 && hosRxxxResultImageDiscoveryInfoPOS[0].item31.includes(2)" class="cancer-margin--l20">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[0].item34">
                <el-radio
            ...
            v-if="hosRxxxResultImageDiscoveryInfoPOS[0].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[0].item3==2 && hosRxxxResultImageDiscoveryInfoPOS[0].item31.includes(2)" class="cancer-margin--l20">
              <el-input v-model="hosRxxxResultImageDiscoveryInfoPOS[0].item35" size="small" clearable></el-input>
            </el-form-item>
            <el-form-item label="3.1.6钙化的深度？" prop="item36" 
            v-if="hosRxxxResultImageDiscoveryInfoPOS[0].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[0].item3==2 && hosRxxxResultImageDiscoveryInfoPOS[0].item31.includes(2)" class="cancer-margin--l20">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[0].item36">
                <el-radio
            ...
            v-if="hosRxxxResultImageDiscoveryInfoPOS[0].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[0].item3==2 && hosRxxxResultImageDiscoveryInfoPOS[0].item31.includes(2)" class="cancer-margin--l20">
              <el-input v-model="hosRxxxResultImageDiscoveryInfoPOS[0].item37" v-numberInt:2="hosRxxxResultImageDiscoveryInfoPOS[0].item37" size="small" clearable></el-input>
            </el-form-item>
            <el-form-item label="4.左乳影像结果有无结构扭曲？" prop="item4" v-if="hosRxxxResultImageDiscoveryInfoPOS[0].item1==2">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[0].item4" @change="clearItem(hosRxxxResultImageDiscoveryInfoPOS[0].item4,['item41','item42','item43','item44'],3)">
                <el-radio
            ...
            <el-form-item label="4.1结构扭曲的象限？" prop="item41" v-if="hosRxxxResultImageDiscoveryInfoPOS[0].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[0].item4==2" class="cancer-margin--l20">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[0].item41">
                <el-radio
            ...
            <el-form-item label="4.2结构扭曲的钟点？" prop="item42" v-if="hosRxxxResultImageDiscoveryInfoPOS[0].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[0].item4==2" class="cancer-margin--l20">
              <el-input v-model="hosRxxxResultImageDiscoveryInfoPOS[0].item42" size="small" clearable></el-input>
            </el-form-item>
            <el-form-item label="4.3结构扭曲的深度？" prop="item43" v-if="hosRxxxResultImageDiscoveryInfoPOS[0].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[0].item4==2" class="cancer-margin--l20">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[0].item43">
                <el-radio
            ...
            <el-form-item label="4.4结构扭曲距离乳头距离？（cm）" prop="item44" v-if="hosRxxxResultImageDiscoveryInfoPOS[0].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[0].item4==2" class="cancer-margin--l20">
              <el-input v-model="hosRxxxResultImageDiscoveryInfoPOS[0].item44" v-numberInt:2="hosRxxxResultImageDiscoveryInfoPOS[0].item44" size="small" clearable></el-input>
            </el-form-item>
            <el-form-item label="5.左乳影像结果有无局灶性不对称致密？" prop="item5" v-if="hosRxxxResultImageDiscoveryInfoPOS[0].item1==2">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[0].item5" @change="clearItem(hosRxxxResultImageDiscoveryInfoPOS[0].item5,['item51','item52','item53','item54'],3)">
                <el-radio
            ...
            <el-form-item label="5.1局灶性不对称致密的象限？" prop="item51" v-if="hosRxxxResultImageDiscoveryInfoPOS[0].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[0].item5==2" class="cancer-margin--l20">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[0].item51">
                <el-radio
            ...
            <el-form-item label="5.2局灶性不对称致密的钟点？" prop="item52" v-if="hosRxxxResultImageDiscoveryInfoPOS[0].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[0].item5==2" class="cancer-margin--l20">
              <el-input v-model="hosRxxxResultImageDiscoveryInfoPOS[0].item52" size="small" clearable></el-input>
            </el-form-item>
            <el-form-item label="5.3局灶性不对称致密的深度？" prop="item53" v-if="hosRxxxResultImageDiscoveryInfoPOS[0].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[0].item5==2" class="cancer-margin--l20">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[0].item53">
                <el-radio
            ...
            <el-form-item label="5.4局灶性不对称致密距离乳头距离？（cm）" prop="item54" v-if="hosRxxxResultImageDiscoveryInfoPOS[0].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[0].item5==2" class="cancer-margin--l20">
              <el-input v-model="hosRxxxResultImageDiscoveryInfoPOS[0].item54" v-numberInt:2="hosRxxxResultImageDiscoveryInfoPOS[0].item54" size="small" clearable></el-input>
            </el-form-item>
            <el-form-item label="6.左乳影像结果有无乳头凹陷？" prop="item6" v-if="hosRxxxResultImageDiscoveryInfoPOS[0].item1==2">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[0].item6">
                <el-radio
            ...
            <el-form-item label="7.左乳影像结果有无皮肤增厚/凹陷？" prop="item7" v-if="hosRxxxResultImageDiscoveryInfoPOS[0].item1==2">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[0].item7">
                <el-radio
            ...
            <el-form-item label="8.左乳影像结果有无腋窝淋巴结肿大？" prop="item8" v-if="hosRxxxResultImageDiscoveryInfoPOS[0].item1==2">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[0].item8">
                <el-radio
            ...
            <el-form-item label="9.左乳影像结果有无其他异常？" prop="item9" v-if="hosRxxxResultImageDiscoveryInfoPOS[0].item1==2">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[0].item9" @change="clearItem(hosRxxxResultImageDiscoveryInfoPOS[0].item9,['abnormalDetail'],3)">
                <el-radio
            ...
            <el-form-item label="9.1请详细描述异常情况：" prop="abnormalDetail" v-if="hosRxxxResultImageDiscoveryInfoPOS[0].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[0].item9==2" class="cancer-margin--l20">
              <el-input type="textarea" v-model="hosRxxxResultImageDiscoveryInfoPOS[0].abnormalDetail" size="small" clearable maxlength="100"></el-input>
            </el-form-item>
          </el-row>
          </el-form>
          ...
          <el-row class="discover">
            <el-form-item label="1.右乳影像结果有无异常？ " prop="item1">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[1].item1"
            ...
            <el-form-item label="2.右乳影像结果有无肿块？" prop="item2" v-if="hosRxxxResultImageDiscoveryInfoPOS[1].item1==2">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[1].item2" @change="clearItem(hosRxxxResultImageDiscoveryInfoPOS[1].item2,['item21','item22','item23','item24','item25','item26','item27','item28'],4)">
                <el-radio
                  v-for="item in POS.item2"
                  :key="item.key"
                  :label="item.key">{{item.name}}</el-radio>
            ...
            <el-form-item label="2.1肿块的形态？" prop="item21" v-if="hosRxxxResultImageDiscoveryInfoPOS[1].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[1].item2==2" class="cancer-margin--l20">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[1].item21">
                <el-radio
                  v-for="item in POS.item21"
                  :key="item.key"
                  :label="item.key">{{item.name}}</el-radio>
            ...
            <el-form-item label="2.2肿块的边缘？" prop="item22" v-if="hosRxxxResultImageDiscoveryInfoPOS[1].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[1].item2==2" class="cancer-margin--l20">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[1].item22">
                <el-radio
                  v-for="item in POS.item22"
                  :key="item.key"
                  :label="item.key">{{item.name}}</el-radio>
            ...
            <el-form-item label="2.3肿块的密度？" prop="item23" v-if="hosRxxxResultImageDiscoveryInfoPOS[1].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[1].item2==2" class="cancer-margin--l20">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[1].item23">
                <el-radio
                  v-for="item in POS.item23"
                  :key="item.key"
                  :label="item.key">{{item.name}}</el-radio>
            ...
            <el-form-item label="2.4肿块的最大径？" prop="item24" v-if="hosRxxxResultImageDiscoveryInfoPOS[1].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[1].item2==2" class="cancer-margin--l20">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[1].item24">
                <el-radio
                  v-for="item in POS.item24"
                  :key="item.key"
                  :label="item.key">{{item.name}}</el-radio>
            ...
            <el-form-item label="2.5肿块的象限？" prop="item25" v-if="hosRxxxResultImageDiscoveryInfoPOS[1].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[1].item2==2" class="cancer-margin--l20">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[1].item25">
                <el-radio
                  v-for="item in POS.item25"
                  :key="item.key"
                  :label="item.key">{{item.name}}</el-radio>
            ...
            <el-form-item label="2.6肿块的钟点？" prop="item26" v-if="hosRxxxResultImageDiscoveryInfoPOS[1].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[1].item2==2" class="cancer-margin--l20">
              <el-input v-model="hosRxxxResultImageDiscoveryInfoPOS[1].item26" size="small" clearable></el-input>
            </el-form-item>
            <el-form-item label="2.7肿块的深度？" prop="item27" v-if="hosRxxxResultImageDiscoveryInfoPOS[1].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[1].item2==2" class="cancer-margin--l20">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[1].item27">
                <el-radio
                  v-for="item in POS.item27"
                  :key="item.key"
                  :label="item.key">{{item.name}}</el-radio>
            ...
            <el-form-item label="2.8肿块距乳头距离？（cm）" prop="item28" v-if="hosRxxxResultImageDiscoveryInfoPOS[1].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[1].item2==2" class="cancer-margin--l20">
              <el-input v-model="hosRxxxResultImageDiscoveryInfoPOS[1].item28" v-numberInt:2="hosRxxxResultImageDiscoveryInfoPOS[1].item28" size="small" clearable></el-input>
            </el-form-item>
            <el-form-item label="3.右乳影像结果有无钙化？" prop="item3" v-if="hosRxxxResultImageDiscoveryInfoPOS[1].item1==2">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[1].item3" @change="clearItem(hosRxxxResultImageDiscoveryInfoPOS[1].item3,['item31','item32','item33','item34','item35','item36','item37'],4)">
                <el-radio
                  v-for="item in POS.item3"
                  :key="item.key"
                  :label="item.key">{{item.name}}</el-radio>
            ...
            <el-form-item label="3.1钙化类型" prop="item31" 
            v-if="hosRxxxResultImageDiscoveryInfoPOS[1].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[1].item3==2" class="cancer-margin--l20">
              <el-checkbox-group v-model="hosRxxxResultImageDiscoveryInfoPOS[1].item31" @change="clearItem31(hosRxxxResultImageDiscoveryInfoPOS[1].item31,1)">
                <el-checkbox
                  v-for="item in POS.item31"
                  :key="item.key"
                  :label="item.key">{{item.name}}</el-checkbox>
            ...
            v-if="hosRxxxResultImageDiscoveryInfoPOS[1].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[1].item3==2 && hosRxxxResultImageDiscoveryInfoPOS[1].item31.includes(1)" class="cancer-margin--l20">
              <el-checkbox-group v-model="hosRxxxResultImageDiscoveryInfoPOS[1].item31A">
                <el-checkbox
                  v-for="item in POS.item31A"
                  :key="item.key"
                  :label="item.key">{{item.name}}</el-checkbox>
            ...
            v-if="hosRxxxResultImageDiscoveryInfoPOS[1].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[1].item3==2 && hosRxxxResultImageDiscoveryInfoPOS[1].item31.includes(2)" class="cancer-margin--l20">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[1].item32">
                <el-radio
                  v-for="item in POS.item32"
                  :key="item.key"
                  :label="item.key">{{item.name}}</el-radio>
            ...
            <el-form-item label="3.1.3钙化的分布？" prop="item33" 
            v-if="hosRxxxResultImageDiscoveryInfoPOS[1].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[1].item3==2 && hosRxxxResultImageDiscoveryInfoPOS[1].item31.includes(2)" class="cancer-margin--l20">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[1].item33">
                <el-radio
                  v-for="item in POS.item33"
                  :key="item.key"
                  :label="item.key">{{item.name}}</el-radio>
            ...
            <el-form-item label="3.1.4钙化的象限？" prop="item34" 
            v-if="hosRxxxResultImageDiscoveryInfoPOS[1].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[1].item3==2 && hosRxxxResultImageDiscoveryInfoPOS[1].item31.includes(2)" class="cancer-margin--l20">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[1].item34">
                <el-radio
                  v-for="item in POS.item34"
                  :key="item.key"
                  :label="item.key">{{item.name}}</el-radio>
            ...
            <el-form-item label="3.1.5钙化的钟点？" prop="item35" 
            v-if="hosRxxxResultImageDiscoveryInfoPOS[1].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[1].item3==2 && hosRxxxResultImageDiscoveryInfoPOS[1].item31.includes(2)" class="cancer-margin--l20">
              <el-input v-model.trim="hosRxxxResultImageDiscoveryInfoPOS[1].item35" size="small" clearable></el-input>
            </el-form-item>
            <el-form-item label="3.1.6钙化的深度？" prop="item36" 
            v-if="hosRxxxResultImageDiscoveryInfoPOS[1].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[1].item3==2 && hosRxxxResultImageDiscoveryInfoPOS[1].item31.includes(2)" class="cancer-margin--l20">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[1].item36">
                <el-radio
                  v-for="item in POS.item36"
                  :key="item.key"
                  :label="item.key">{{item.name}}</el-radio>
            ...
            <el-form-item label="3.1.7钙化距离乳头距离？（cm）" prop="item37" 
            v-if="hosRxxxResultImageDiscoveryInfoPOS[1].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[1].item3==2 && hosRxxxResultImageDiscoveryInfoPOS[1].item31.includes(2)" class="cancer-margin--l20">
              <el-input v-model.trim="hosRxxxResultImageDiscoveryInfoPOS[1].item37" v-numberInt:2="hosRxxxResultImageDiscoveryInfoPOS[1].item37" size="small" clearable></el-input>
            </el-form-item>
            <el-form-item label="4.右乳影像结果有无结构扭曲？" prop="item4" v-if="hosRxxxResultImageDiscoveryInfoPOS[1].item1==2">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[1].item4" @change="clearItem(hosRxxxResultImageDiscoveryInfoPOS[1].item4,['item41','item42','item43','item44'],4)">
                <el-radio
                  v-for="item in POS.item4"
                  :key="item.key"
                  :label="item.key">{{item.name}}</el-radio>
            ...
            <el-form-item label="4.1结构扭曲的象限？" prop="item41" v-if="hosRxxxResultImageDiscoveryInfoPOS[1].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[1].item4==2" class="cancer-margin--l20">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[1].item41">
                <el-radio
                  v-for="item in POS.item41"
                  :key="item.key"
                  :label="item.key">{{item.name}}</el-radio>
            ...
            <el-form-item label="4.2结构扭曲的钟点？" prop="item42" v-if="hosRxxxResultImageDiscoveryInfoPOS[1].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[1].item4==2" class="cancer-margin--l20">
              <el-input v-model="hosRxxxResultImageDiscoveryInfoPOS[1].item42" size="small" clearable></el-input>
            </el-form-item>
            <el-form-item label="4.3结构扭曲的深度？" prop="item43" v-if="hosRxxxResultImageDiscoveryInfoPOS[1].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[1].item4==2" class="cancer-margin--l20">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[1].item43">
                <el-radio
                  v-for="item in POS.item43"
                  :key="item.key"
                  :label="item.key">{{item.name}}</el-radio>
            ...
            <el-form-item label="4.4结构扭曲距离乳头距离？（cm）" prop="item44" v-if="hosRxxxResultImageDiscoveryInfoPOS[1].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[1].item4==2" class="cancer-margin--l20">
              <el-input v-model="hosRxxxResultImageDiscoveryInfoPOS[1].item44" v-numberInt:2="hosRxxxResultImageDiscoveryInfoPOS[1].item44" size="small" clearable></el-input>
            </el-form-item>
            <el-form-item label="5.右乳影像结果有无局灶性不对称致密？" prop="item5" v-if="hosRxxxResultImageDiscoveryInfoPOS[1].item1==2">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[1].item5" @change="clearItem(hosRxxxResultImageDiscoveryInfoPOS[1].item5,['item51','item52','item53','item54'],4)">
                <el-radio
                  v-for="item in POS.item5"
                  :key="item.key"
                  :label="item.key">{{item.name}}</el-radio>
            ...
            <el-form-item label="5.1局灶性不对称致密的象限？" prop="item51" v-if="hosRxxxResultImageDiscoveryInfoPOS[1].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[1].item5==2" class="cancer-margin--l20">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[1].item51">
                <el-radio
                  v-for="item in POS.item51"
                  :key="item.key"
                  :label="item.key">{{item.name}}</el-radio>
            ...
            <el-form-item label="5.2局灶性不对称致密的钟点？" prop="item52" v-if="hosRxxxResultImageDiscoveryInfoPOS[1].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[1].item5==2" class="cancer-margin--l20">
              <el-input v-model="hosRxxxResultImageDiscoveryInfoPOS[1].item52" size="small" clearable></el-input>
            </el-form-item>
            <el-form-item label="5.3局灶性不对称致密的深度？" prop="item53" v-if="hosRxxxResultImageDiscoveryInfoPOS[1].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[1].item5==2" class="cancer-margin--l20">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[1].item53">
                <el-radio
                  v-for="item in POS.item53"
                  :key="item.key"
                  :label="item.key">{{item.name}}</el-radio>
            ...
            <el-form-item label="5.4局灶性不对称致密距离乳头距离？（cm）" prop="item54" v-if="hosRxxxResultImageDiscoveryInfoPOS[1].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[1].item5==2" class="cancer-margin--l20">
              <el-input v-model="hosRxxxResultImageDiscoveryInfoPOS[1].item54" v-numberInt:2="hosRxxxResultImageDiscoveryInfoPOS[1].item54" size="small" clearable></el-input>
            </el-form-item>
            <el-form-item label="6.右乳影像结果有无乳头凹陷？" prop="item6" v-if="hosRxxxResultImageDiscoveryInfoPOS[1].item1==2">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[1].item6">
                <el-radio
                  v-for="item in POS.item6"
                  :key="item.key"
                  :label="item.key">{{item.name}}</el-radio>
            ...
            <el-form-item label="7.右乳影像结果有无皮肤增厚/凹陷？" prop="item7" v-if="hosRxxxResultImageDiscoveryInfoPOS[1].item1==2">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[1].item7">
                <el-radio
                  v-for="item in POS.item7"
                  :key="item.key"
                  :label="item.key">{{item.name}}</el-radio>
            ...
            <el-form-item label="8.右乳影像结果有无腋窝淋巴结肿大？" prop="item8" v-if="hosRxxxResultImageDiscoveryInfoPOS[1].item1==2">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[1].item8">
                <el-radio
                  v-for="item in POS.item8"
                  :key="item.key"
                  :label="item.key">{{item.name}}</el-radio>
            ...
            <el-form-item label="9.右乳影像结果有无其他异常？" prop="item9" v-if="hosRxxxResultImageDiscoveryInfoPOS[1].item1==2">
              <el-radio-group v-model="hosRxxxResultImageDiscoveryInfoPOS[1].item9" @change="clearItem(hosRxxxResultImageDiscoveryInfoPOS[1].item9,['abnormalDetail'],4)">
                <el-radio
                  v-for="item in POS.item9"
                  :key="item.key"
                  :label="item.key">{{item.name}}</el-radio>
            ...
            <el-form-item label="9.1请详细描述异常情况：" prop="abnormalDetail" v-if="hosRxxxResultImageDiscoveryInfoPOS[1].item1==2 && hosRxxxResultImageDiscoveryInfoPOS[1].item9==2" class="cancer-margin--l20">
              <el-input type="textarea" v-model="hosRxxxResultImageDiscoveryInfoPOS[1].abnormalDetail" size="small" clearable maxlength="100"></el-input>
            </el-form-item>
          </el-row>
        </el-form>
        ...
        <h2>影像评估结果</h2>
            <el-row>
              <el-form-item label="1.左乳BI-RADS分类？" prop="item51" class="blockTit">
                <el-radio-group v-model="form.item51">
                  <el-radio
            ...
            <el-row>
              <el-form-item label="2.右乳BI-RADS分类？" prop="item52" class="blockTit">
                <el-radio-group v-model="form.item52">
                  <el-radio
            ...
            <el-row>
              <el-form-item label="3.双乳BI-RADS分类？" prop="item53" class="blockTit">
                <el-radio-group v-model="form.item53">
                  <el-radio
          ...
          <h2>处理建议</h2>
            <el-row>
              <el-form-item label="1.左乳处理建议：" prop="item61"  class="blockTit">
                <el-radio-group v-model="form.item61">
                  <el-radio
            ...
            <el-row>
              <el-form-item label="2.右乳处理建议：" prop="item62"  class="blockTit">
                <el-radio-group v-model="form.item62">
                  <el-radio
            ...
            <el-row>
              <el-form-item label="3.双乳处理建议：" prop="item63"  class="blockTit">
                <el-radio-group v-model="form.item63">
                  <el-radio
            ...
            <el-row>
              <el-form-item label="4.其他处理建议：" prop="item64">
                <el-input v-model.trim="form.item64" size="small" placeholder="请输入其他处理建议" clearable maxlength="100"></el-input>
              </el-form-item>
            </el-row>
          <h2>会诊</h2>
          <el-row class="discover">
...
import { isArray } from 'util';
  export default {
    ...
    data() {
      return {
        ...
        leftRules: {
          ...
          item28: [
            { required: true, message: '必选', trigger: 'blur' },
            { required: true, validator: VALIDATE.add0100 }
            ],
          item3: [{ required: true, message: '必选', trigger: 'change' }],
          item31: [{ required: true, message: '必选', trigger: 'change' }],
    ...
    methods: {
      ...
      submitData (status) {
        this.hosRxxxResultImageDiscoveryInfoPOS[0].item31= this.hosRxxxResultImageDiscoveryInfoPOS[0].item31.length?this.sortArray(this.hosRxxxResultImageDiscoveryInfoPOS[0].item31).join(','):null
        this.hosRxxxResultImageDiscoveryInfoPOS[0].item31A= this.hosRxxxResultImageDiscoveryInfoPOS[0].item31A.length?this.sortArray(this.hosRxxxResultImageDiscoveryInfoPOS[0].item31A).join(','):null
        this.hosRxxxResultImageDiscoveryInfoPOS[1].item31= this.hosRxxxResultImageDiscoveryInfoPOS[1].item31.length?this.sortArray(this.hosRxxxResultImageDiscoveryInfoPOS[1].item31).join(','):null
        this.hosRxxxResultImageDiscoveryInfoPOS[1].item31A= this.hosRxxxResultImageDiscoveryInfoPOS[1].item31A.length?this.sortArray(this.hosRxxxResultImageDiscoveryInfoPOS[1].item31A).join(','):null
          this.$axios_http({
            ...
            this.form, 
            {
              ...
              item1: this.form.item1.length?this.sortArray(this.form.item1).join(','):null,
      ...
      clearItem(val,data,type){
        if(type==1 && !val.includes(2)){
          ...
          for(let item of data){
            if(item === 'item31' || item === 'item31A' ){
              this.hosRxxxResultImageDiscoveryInfoPOS[0][item] = [];
            }else{
          ...
          for(let item of data){
            if(item === 'item31'){
              this.hosRxxxResultImageDiscoveryInfoPOS[1][item] = [];
            }else{
      ...
      clearItem31(val,i){
        if(!val.includes(1)){
          this.hosRxxxResultImageDiscoveryInfoPOS[i].item31A = [];
        }
        if(!val.includes(2)){
          this.hosRxxxResultImageDiscoveryInfoPOS[i].item32 = null
          this.hosRxxxResultImageDiscoveryInfoPOS[i].item33 = null
          this.hosRxxxResultImageDiscoveryInfoPOS[i].item34 = null
          this.hosRxxxResultImageDiscoveryInfoPOS[i].item35 = null
          this.hosRxxxResultImageDiscoveryInfoPOS[i].item36 = null
          this.hosRxxxResultImageDiscoveryInfoPOS[i].item37 = null
        }
      },
      //  查询结果
      getResultInfo(){
