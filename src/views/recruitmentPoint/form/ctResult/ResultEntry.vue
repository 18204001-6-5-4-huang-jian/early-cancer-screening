            ...
            <cancer-widget>
                ...
                <el-form :model="form" :rules="formRules" ref="form" class="demo-form">
                    ...
                    <el-row class="bigTitle">
                        ...
                        prop="item01" 
                        class="blockTit">
                            <el-radio-group v-model="form.item01"
                    ...
                    <el-row v-if="form.item01!=1">
                        <el-form-item label="2．肺囊肿/肺大泡" prop="item2">
                            <el-radio-group v-model="form.item2" @change="clearItem(form.item2,[],['item2A'],1)">
                                <el-radio :label="1">1.无</el-radio>
                                <el-radio :label="2">2.有</el-radio>
                            </el-radio-group>
                        </el-form-item>
                    ...
                    <el-row v-if="form.item2 == 2">
                        <el-form-item label="2.1．肺囊肿/肺大泡的位置：" prop="item2A" class="blockTit">
                            <el-checkbox-group v-model="form.item2A">
                    ...
                    <el-row v-if="form.item01!=1">
                        <el-form-item label="3．小气道病变/支扩" prop="item3">
                            <el-radio-group v-model="form.item3" @change="clearItem(form.item3,[],['item3A'],1)">
                                <el-radio :label="1">1.无</el-radio>
                                <el-radio :label="2">2.有</el-radio>
                            </el-radio-group>
                        </el-form-item>
                    ...
                    <el-row v-if="form.item3 == 2">
                        <el-form-item label="3.1．小气道病变/支扩的位置：" prop="item3A" class="blockTit">
                            <el-checkbox-group v-model="form.item3A">
                                <el-checkbox label="1">1.RUL</el-checkbox>
                                <el-checkbox label="2">2.RML</el-checkbox>
                                <el-checkbox label="3">3.RLL</el-checkbox>
                                <el-checkbox label="4">4.LUL</el-checkbox>
                    ...
                    <el-row v-if="form.item01!=1">
                        <el-form-item label="4．肺间质疾病" prop="item4">
                            <el-radio-group v-model="form.item4" @change="clearItem(form.item4,[],['item4A'],1)">
                                <el-radio :label="1">1.无</el-radio>
                                <el-radio :label="2">2.有</el-radio>
                            </el-radio-group>
                        </el-form-item>
                    ...
                    <el-row v-if="form.item4 == 2">
                        <el-form-item label="4.1．肺间质疾病的位置：" prop="item4A" class="blockTit">
                            <el-checkbox-group v-model="form.item4A">
                                <el-checkbox label="1">1.RUL</el-checkbox>
                                <el-checkbox label="2">2.RML</el-checkbox>
                                <el-checkbox label="3">3.RLL</el-checkbox>
                                <el-checkbox label="4">4.LUL</el-checkbox>
                    ...
                    <el-row v-if="form.item5 == 2">
                        <el-form-item label="5.1．纤维瘢痕的位置：" prop="item5A" class="blockTit">
                            <el-checkbox-group v-model="form.item5A">
                                <el-checkbox label="1">1.RUL</el-checkbox>
                                <el-checkbox label="2">2.RML</el-checkbox>
                                <el-checkbox label="3">3.RLL</el-checkbox>
                                <el-checkbox label="4">4.LUL</el-checkbox>
                    ...
                    <el-row v-if="form.item01!=1">
                        <el-form-item label="6．肺不张" prop="item6">
                            <el-radio-group v-model="form.item6" @change="clearItem(form.item6,[],['item6A'],1)">
                                <el-radio :label="1">1.无</el-radio>
                                <el-radio :label="2">2.有</el-radio>
                            </el-radio-group>
                        </el-form-item>
                    ...
                    <el-row v-if="form.item6 == 2">
                        <el-form-item label="6.1．肺不张的位置：" prop="item6A" class="blockTit">
                            <el-checkbox-group v-model="form.item6A">
                                <el-checkbox label="1">1.RUL</el-checkbox>
                                <el-checkbox label="2">2.RML</el-checkbox>
                                <el-checkbox label="3">3.RLL</el-checkbox>
                                <el-checkbox label="4">4.LUL</el-checkbox>
                    ...
                    <el-row v-if="form.item01!=1">
                        <el-form-item label="对肺实质异常的其他描述：" prop="item07" class="blockTit" style="width:50%;">
                            <el-input type="textarea" v-model="form.item07" maxlength="100" placeholder="不超过100个字" ></el-input>
                        </el-form-item>
                    </el-row>
                    <!-- 第二部分 -->
                    <el-row class="bigTitle">
                        <el-form-item label="二、本次检查是否存在胸腔积液或胸膜异常（胸膜斑块、胸膜钙化、胸膜增厚、胸膜/胸腔肿物和胸腔肿物）？" prop="item7"  class="blockTit">
                            <el-radio-group v-model="form.item7"
                        ...
                        <el-row v-if="form.item7!=1">
                            <el-form-item label="1.1 胸腔积液（右侧） " prop="item7B" class="blockTit">
                                <el-radio-group v-model="form.item7B">
                                    <el-radio :label="1">1.无</el-radio>
                        ...
                        <el-row v-if="form.item7!=1">
                            <el-form-item label="1.2 胸腔积液（左侧）" prop="item7A" class="blockTit">
                                <el-radio-group v-model="form.item7A">
                                    <el-radio :label="1">1.无</el-radio>
                                    <el-radio :label="2">2.少量</el-radio>
                                    <el-radio :label="3">3.中量</el-radio>
                                    <el-radio :label="4">4.大量</el-radio>
                        ...
                        <el-row v-if="form.item7!=1">
                            <el-form-item label="2. 胸膜增厚或胸膜斑块" prop="item7C">
                                <el-radio-group v-model="form.item7C"  @change="clearItem(form.item7C,[],['item7C1'],1)">
                                    <el-radio :label="1">1.无</el-radio>
                                    <el-radio :label="2">2.有</el-radio>
                                </el-radio-group>
                            </el-form-item>
                         ...
                         <el-row v-if="form.item7C==2">
                            <el-form-item label="2.1 胸膜增厚或胸膜斑块的位置：" prop="item7C1">
                                <el-checkbox-group v-model="form.item7C1">
                         ...
                         <el-row  v-if="form.item7!=1">
                            <el-form-item label="3. 胸膜钙化" prop="item7C2">
                                <el-radio-group v-model="form.item7C2">
                                    <el-radio :label="1">1.无</el-radio>
                                    <el-radio :label="2">2.有</el-radio>
                                </el-radio-group>
                            </el-form-item> 
                         ...
                         <el-row  v-if="form.item7!=1">
                            <el-form-item label="4. 胸膜肿物" prop="item7C3">
                                <el-radio-group v-model="form.item7C3">
                                    <el-radio :label="1">1.无</el-radio>
                                    <el-radio :label="2">2.有</el-radio>
                                </el-radio-group>
                            </el-form-item> 
                        ...
                        <el-row class="bigTitle">
                            <el-form-item label="三、本次检查心脏或大血管是否存在以下异常？（如：主动脉壁钙化、房室增大、瓣膜钙化、心包积液等）" prop="item8"  class="blockTit">
                                <el-radio-group v-model="form.item8"
                         ...
                         <el-row v-if="form.item8!=1">
                            <el-form-item label="1. 主动脉壁钙化" prop="item81">
                                <el-radio-group v-model="form.item81">
                                    <el-radio :label="1">1.无</el-radio>
                                    <el-radio :label="2">2.有</el-radio>
                                </el-radio-group>
                            </el-form-item>
                          ...
                          <el-row v-if="form.item8!=1">
                            <el-form-item label="2. 房室增大" prop="item82">
                                <el-radio-group v-model="form.item82">
                                    <el-radio :label="1">1.无</el-radio>
                                    <el-radio :label="2">2.有</el-radio>
                                </el-radio-group>
                            </el-form-item>
                        ...
                        <el-row v-if="form.item8!=1">
                            <el-form-item label="3. 瓣膜钙化" prop="item83">
                                <el-radio-group v-model="form.item83">
                                    <el-radio :label="1">1.无</el-radio>
                                    <el-radio :label="2">2.有</el-radio>
                                </el-radio-group>
                            </el-form-item>
                         ...
                         <el-row v-if="form.item8!=1">
                            <el-form-item label="4. 心包积液" prop="item8E">
                                <el-radio-group v-model="form.item8E">
                                    <el-radio :label="1">1.无</el-radio>
                                    <el-radio :label="2">2.少量</el-radio>
                                    <el-radio :label="3">3.中量</el-radio>
                                    <el-radio :label="4">4.大量</el-radio>
                        ...
                        <el-row class="bigTitle">
                            <el-form-item label="四、本次检查是否存在冠状动脉钙化？（钙化范围小于1/3为轻，1/3至2/3为中，2/3以上为重）" prop="item8A0"  class="blockTit">
                                <el-radio-group v-model="form.item8A0"
                    ...
                    <el-row v-if="form.item8A0==2">
                        <el-form-item label="1. 左主干" prop="item8A"
                                      class="blockTit">
                            <el-radio-group v-model="form.item8A">
                                <el-radio :label="1">1.无</el-radio>
                                <el-radio :label="2">2.轻</el-radio>
                                <el-radio :label="3">3.中</el-radio>
                                <el-radio :label="4">4.重</el-radio>
                    ...
                    <el-row v-if="form.item8A0==2">
                        <el-form-item label="2. 前降支" prop="item8B" class="blockTit">
                            <el-radio-group v-model="form.item8B">
                                <el-radio :label="1">1.无</el-radio>
                                <el-radio :label="2">2.轻</el-radio>
                                <el-radio :label="3">3.中</el-radio>
                                <el-radio :label="4">4.重</el-radio>
                    ...
                    <el-row v-if="form.item8A0==2">
                        <el-form-item label="3. 回旋支" prop="item8C" class="blockTit">
                            <el-radio-group v-model="form.item8C">
                                <el-radio :label="1">1.无</el-radio>
                                <el-radio :label="2">2.轻</el-radio>
                                <el-radio :label="3">3.中</el-radio>
                                <el-radio :label="4">4.重</el-radio>
                    ...
                    <el-row v-if="form.item8A0==2">
                        <el-form-item label="4. 右主干" prop="item8D" class="blockTit">
                            <el-radio-group v-model="form.item8D">
                                <el-radio :label="1">1.无</el-radio>
                                <el-radio :label="2">2.轻</el-radio>
                                <el-radio :label="3">3.中</el-radio>
                                <el-radio :label="4">4.重</el-radio>
                    ...
                    <el-row class="bigTitle">
                        <el-form-item label="五、本次检查是否存在甲状腺/纵隔异常？" prop="item9"  class="blockTit">
                            <el-radio-group v-model="form.item9"
                    ...
                    <el-row v-if="form.item9!=1">
                        <el-form-item label="1. 甲状腺是否存在异常？（钙化、囊肿、肿瘤等）" prop="item9A">
                            <el-radio-group v-model="form.item9A" @change="clearItem(form.item9A,['item9AA1'],['item9AA'],1)">
                                <el-radio :label="1">1.无</el-radio>
                                <el-radio :label="2">2.有</el-radio>
                            </el-radio-group>
                        </el-form-item>
                    ...
                    <el-row v-if="form.item9A==2">
                        <el-form-item label="1.1. 甲状腺异常的具体描述：" prop="item9AA" class="blockTit">
                            <el-checkbox-group v-model="form.item9AA"  @change="clearItem(form.item9AA,['item9AA1'],[],1)">
                    ...
                    <el-row v-if="form.item9AA.includes('4')">
                        <el-form-item label="甲状腺其他情况：" prop="item9AA1" labelWidth="140px" style="width:50%;">
                            <el-input type="textarea" v-model="form.item9AA1" maxlength="100" placeholder="不超过100个字"></el-input>
                        </el-form-item>
                    </el-row>
                    <el-row v-if="form.item9!=1">
                        <el-form-item label="2. 胸腺是否存在异常？（钙化、囊肿、肿瘤等）" prop="item9B">
                            <el-radio-group v-model="form.item9B" @change="clearItem(form.item9B,['item9BA1'],['item9BA'],1)">
                                <el-radio :label="1">1.无</el-radio>
                                <el-radio :label="2">2.有</el-radio>
                            </el-radio-group>
                        </el-form-item>
                    ...
                    <el-row v-if="form.item9B==2">
                        <el-form-item label="2.1. 胸腺异常的具体描述：" prop="item9BA" class="blockTit">
                            <el-checkbox-group v-model="form.item9BA">
                                <el-checkbox label="1">1.钙化</el-checkbox>
                                <el-checkbox label="2">2.囊肿</el-checkbox>
                                <el-checkbox label="3">3.肿瘤</el-checkbox>
                                <el-checkbox label="4">4.其他</el-checkbox>
                    ...
                    <el-row v-if="form.item9BA.includes('4')">
                        <el-form-item label="胸腺其他情况：" prop="item9BA1" labelWidth="120px" style="width:50%;">
                            <el-input type="textarea" v-model="form.item9BA1"  maxlength="100" placeholder="不超过100个字"></el-input>
                        </el-form-item>
                    </el-row>
                    <el-row  v-if="form.item9!=1">
                        <el-form-item label="3. 淋巴结（肺门或纵隔短径≥10mm及任意大小食管旁淋巴结）" prop="item9C">
                            <el-radio-group v-model="form.item9C" @change="clearItem(form.item9C,[],['item9COtherArr'],1)">
                                <el-radio :label="1">1.无</el-radio>
                                <el-radio :label="2">2.有</el-radio>
                            </el-radio-group>
                        </el-form-item>
                    ...
                    <el-row v-if="form.item9C==2">
                             <el-form-item label="部位名称：" prop="item9COtherArr" class="blockTit">
                                <el-checkbox-group v-model="form.item9COtherArr">
                                    <el-checkbox 
                    ...
                    <el-row v-if="form.item9!=1">
                        <el-form-item label="4. 是否存在肺门或纵隔钙化淋巴结？" prop="item9D">
                            <el-radio-group v-model="form.item9D">
                                <el-radio :label="1">1.无</el-radio>
                                <el-radio :label="2">2.有</el-radio>
                            </el-radio-group>
                        </el-form-item>
                    ...
                    <el-row v-if="form.item9!=1">
                        <el-form-item label="5. 是否存在腋窝淋巴结？" prop="item9E">
                            <el-radio-group v-model="form.item9E" @change="clearItem(form.item9E,['item9EOther'],['item9EA'],1)">
                                <el-radio :label="1">1.无</el-radio>
                                <el-radio :label="2">2.有</el-radio>
                            </el-radio-group>
                        </el-form-item>
                    ...
                    <el-row v-if="form.item9E==2">
                        <el-form-item label="5.1. 腋窝淋巴结的位置：" prop="item9EA">
                            <el-checkbox-group v-model="form.item9EA">
                                <el-checkbox label="1">1.右</el-checkbox>
                                <el-checkbox label="2">2.左</el-checkbox>
                            </el-checkbox-group>
                        </el-form-item>
                    ...
                    <el-row v-if="form.item9E==2">
                        <el-form-item label="详细描述：" labelWidth="120px" prop="item9EOther"  style="width:50%;">
                            <el-input type="textarea" v-model="form.item9EOther" maxlength="100" placeholder="不超过100个字"></el-input>
                        </el-form-item>
                    </el-row>
                    <el-row v-if="form.item9!=1">
                        <el-form-item label="6. 食管是否存在异常？" prop="item9F">
                            <el-radio-group v-model="form.item9F" @change="clearItem(form.item9F,['item9FOther'],[],1)">
                                <el-radio :label="1">1.无</el-radio>
                                <el-radio :label="2">2.有</el-radio>
                            </el-radio-group>
                        </el-form-item>
                    ...
                    <el-row v-if="form.item9F==2">
                        <el-form-item label="详细描述：" labelWidth="120px" prop="item9FOther" style="width:50%;">
                            <el-input v-model="form.item9FOther" type="textarea"
                                    maxlength="100" placeholder="不超过100个字"></el-input>
                        </el-form-item>
                    </el-row>
                    <el-row v-if="form.item9!=1">
                        <el-form-item label="7. 是否存在裂孔疝？" prop="item9G">
                            <el-radio-group v-model="form.item9G" @change="clearItem(form.item9G,['item9GOther'],[],1)">
                                <el-radio :label="1">1.无</el-radio>
                                <el-radio :label="2">2.有</el-radio>
                            </el-radio-group>
                        </el-form-item>
                    ...
                    <el-row v-if="form.item9G==2">
                        <el-form-item label="详细描述：" prop="item9GOther" labelWidth="120px" style="width:50%;">
                            <el-input v-model="form.item9GOther" type="textarea" placeholder="不超过100个字"
                                    maxlength="100"></el-input>
                        </el-form-item>
                    </el-row>
                    <el-row v-if="form.item9!=1">
                        <el-form-item label="本次检查甲状腺/纵隔异常的附加描述：" prop="item9H" class="blockTit">
                            <el-input v-model="form.item9H" type="textarea" :rows="2"
                        ...
                        <el-row class="bigTitle">
                            ...
                            <el-radio-group v-model="form.item10" @change="clearItem(form.item10,['item10A'],[],1)">
                                <el-radio :label="1">1.无</el-radio>
                                <el-radio :label="2">2.有</el-radio>
                            </el-radio-group>
                        </el-form-item>
                        ...
                        <el-row v-if="form.item10==2">
                            <el-form-item label="详细描述：" prop="item10A" labelWidth="120px" style="width:50%;">
                                <el-input v-model="form.item10A" type="textarea" placeholder="不超过100个字" maxlength="100"></el-input>
                            </el-form-item>
                        </el-row>
                        <el-row class="bigTitle">
                             <el-form-item label="七、本次检查是否存在腹部异常？" prop="item11" class="blockTit">
                            <el-radio-group v-model="form.item11" @change="clearItem(form.item11,['item11A'],[],1)">
                                <el-radio :label="1">1.无</el-radio>
                                <el-radio :label="2">2.有</el-radio>
                            </el-radio-group>
                        </el-form-item>
                        ...
                        <el-row v-if="form.item11==2">
                            <el-form-item label="详细描述：" prop="item11A" labelWidth="120px" style="width:50%;">
                                <el-input v-model="form.item11A" type="textarea" placeholder="不超过100个字" maxlength="100"></el-input>
                            </el-form-item>
                        </el-row>
                       <el-row class="bigTitle">
                            <el-form-item label="八. 本次检查是否存在骨质异常？" prop="item12"  class="blockTit">
                            <el-radio-group v-model="form.item12" @change="clearItem(form.item12,['item12Other'],[],1)">
                                <el-radio :label="1">1.无</el-radio>
                                <el-radio :label="2">2.有</el-radio>
                            </el-radio-group>
                        </el-form-item>
                       ...
                       <el-row v-if="form.item12==2">
                            <el-form-item label="详细描述：" prop="item12Other" labelWidth="120px" style="width:50%;">
                                 <el-input v-model="form.item12Other" type="textarea"
                                         maxlength="100" placeholder="不超过100个字"></el-input>
                             </el-form-item>
                        </el-row>
                       <el-row class="bigTitle">
                          <el-form-item label="九、其他表现" prop="item15" class="blockTit">
                              <el-input v-model="form.item15" type="textarea" style="width: 50%;"  placeholder="不超过200个字" maxlength="200"></el-input>
                          </el-form-item>
                       </el-row>
                    ...
                    <el-row>
                        <el-form-item label="1. 是否需要国家癌症中心会诊（复阅）？" prop="item130">
                            <el-radio-group v-model="form.item130">
                    ...
                    <el-row>
                        <el-form-item label="2. 是否需要随诊" prop="item13">
                            <el-radio-group v-model="form.item13" @change="clearItem(form.item13,['item13A','item13B'],[],1)">
                                <el-radio :label="1">1.否</el-radio>
                                <el-radio :label="2">2.是</el-radio>
                            </el-radio-group>
                        </el-form-item>
                    ...
                    <el-row v-if="form.item13==2">
                        <el-form-item label="2.1. 随诊周期是： " prop="item13A" class="blockTit">
                            <el-radio-group v-model="form.item13A" @change="clearitem13B(form.item13A)">
                ...
                ，具体随诊周期（单位:月）：
                  <el-form-item label="" labelWidth="0px" prop="item13B" class="inline" :inline-message="true">
                    <el-input v-model.trim="form.item13B" size="mini"></el-input>
                  </el-form-item>
              </span>
                                </el-radio>
                            </el-radio-group>
                    ...
                    <el-row>
                        <el-form-item label="3. 是否需要临床处理？" prop="item14">
                            <el-radio-group v-model="form.item14" @change="clearItem(form.item14,[],['item14A'],1)">
                                <el-radio :label="1">1.否</el-radio>
                                <el-radio :label="2">2.是</el-radio>
                            </el-radio-group>
                        </el-form-item>
                    ...
                    <el-row v-if="form.item14==2">
                        <el-form-item label="3.1. 临床处理意见（可多选）" prop="item14A" class="blockTit">
                            <el-checkbox-group v-model="form.item14A">
                    ...
                    <el-row>
                        <el-form-item label="填表人员" prop="inputUser" style="display:inline-block;float:left;width:30%;">
                            <el-input v-model.trim="form.inputUser" size="mini" maxlength="50"></el-input>
                        </el-form-item>
                ...
                <div class="btns" v-if="$route.query.flag!=0 &&  $route.query.flag!=2">
                    <!-- <span v-if="$route.query.resultInputStatus != 1">
                        <el-button type="primary" size="small" @click="submitForm('0','add')" v-if="!$route.query.id">保存草稿</el-button>
                        <el-button type="primary" size="small" @click="submitForm('0','edit')" v-if="$route.query.id">保存草稿</el-button>
                    </span> -->
  ...
  data() {
    return {
      ...
      formRules: {
        ...
        item15: [{ required: false, message: "必填", trigger: "blur" }],
  ...
  methods: {
    ...
    submitCTResult(type) {
      ...
      for (let item in this.form) {
        if (this.isArray(this.form[item]) && item != "item9COtherArr") {
          this.form[item] = this.form[item].toString();
        }
      }
      this.$axios_http({
        url: "/base/ct/add/result",
        data: this.form,
        vueObj: this
      }).then(res => {
        if (res.data.status == "SUCCESS") {
...
.el-form-item.radio7 .el-radio-group {
  margin-left: 74px;
}
.el-form-item.radio8 .el-radio-group {
  margin-left: 46px;
}
.el-form-item.radio10 .el-radio-group {
  margin-left: 11px;
}
.el-form-item.radio11 .el-radio-group {
  margin-left: 11px;
}
.btns {
  padding-top: 10px;
