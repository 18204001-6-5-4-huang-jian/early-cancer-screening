...
<div>
  ...
  <div class="reportBox">
    <cancer-widget>
      ...
      <div id="print">
        <h1 style="text-align: center;">结直肠内镜筛查报告</h1>
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item label="评估日期：" >
                <span>{{personDetail.evaluateDate | dateFilter}}</span>
              </el-form-item>
            </el-col>
            <el-col :span="8">
        ...
        <el-form :model="form" :rules="formRules"  ref="form"  class="demo-form">
          ...
          <el-row>
            <el-form-item label="" prop="checkText" class="blockTit">
              <el-input disabled v-model="form.checkText" type="textarea" :autosize="{minRows:4}"></el-input>
            </el-form-item>
          </el-row>
          <h2>内镜下诊断（仅供参考）</h2>
          <el-row>
            <el-form-item label="" prop="njxDiagnosis" class="blockTit">
              <el-input disabled v-model="form.njxDiagnosis"  type="textarea" :autosize="{minRows:4}"></el-input>
            </el-form-item>
          </el-row>
          <h2>填表信息</h2>
          <el-row>
            <el-col :span="12">
              <el-form-item label="报告医师" labelWidth="80px" prop="reportDoctor" class="inline">
                <el-input disabled v-model.trim="form.reportDoctor" size="mini" style="width: 200px;"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="审核医师" labelWidth="80px" prop="examineDoctor" class="inline">
                <el-input disabled v-model.trim="form.examineDoctor" size="mini" style="width: 200px;"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
        </el-form>
      ...
      <!-- <div class="btns" v-if="$route.query.flag!=0 &&  $route.query.flag!=2">
        <router-link :to="{path:'/form/enteroscopyreport',query:{
...
<script>
  ...
  export default {
    mixins: [ mixin,getPersonDetail,getEnteroscopyReport ],
    data() {
      return {
