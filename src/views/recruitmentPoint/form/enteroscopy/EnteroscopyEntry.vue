                ...
                <el-form :model="form" :rules="formRules" ref="form" class="demo-form" :inline="true" labelPosition="left">
                    ...
                    <el-row>
                        <el-form-item label="1. 是否进行了直肠指诊(无法耐受肠镜者)？" prop="item21" >
                            <el-radio-group v-model="form.item21" @change="clearItem(form.item21,['item21A','item21B','item21C','item21D','item21E'],1)">
                    ...
                    <el-row>
                        <el-form-item label="1.1. 参与者直肠指诊结果有无肿块？" prop="item21A" v-if="form.item21 == 1" label-width="285px">
                            <el-radio-group v-model="form.item21A"  @change="clearItem(form.item21A,['item21B','item21C','item21D','item21E'],1)">
                                <el-radio :label="1">1.是</el-radio>
                                <el-radio :label="2">2.否</el-radio>
                            </el-radio-group>
                        </el-form-item>
                    ...
                    <el-row v-if="form.item21A == 1">
                        <el-form-item label="1.1.1 肿块距肛距离(厘米)"  prop="item21B">
                            <el-input type="text" size="mini" v-model="form.item21B" style="width:60px"></el-input>
                        </el-form-item>
                        <el-form-item label="肿块位置(点钟)"  prop="item21C" >
                            <el-input type="text" size="mini"   v-model="form.item21C" style="width:60px;"></el-input>
                        </el-form-item>
                        <el-form-item label="肿块占据肠腔范围(填几分之几)" prop="item21D">
                            <el-input type="text" size="mini"   v-model="form.item21D"  style="width:60px;"></el-input>
                        </el-form-item>
                        <span class="input-span">/</span>
                        <el-form-item label=""  prop="item21E" >
                            <el-input type="text" size="mini"  v-model="form.item21E"  style="width:60px;"></el-input>
                        </el-form-item>
                    </el-row>
                    <el-row>
                        <el-form-item label="2. 参与者是否完成了结肠镜检查？"  prop="item22"  label-width="285px">
                            <el-radio-group v-model="form.item22" @change="clearItem22(form.item22)">
                                <el-radio :label="1">1.是</el-radio>
                                <el-radio :label="2">2.否</el-radio>
                            </el-radio-group>
                        </el-form-item>
                    ...
                    <div v-if="form.item22!=2">
                        ...
                        <el-row>
                            <el-form-item label="1. 肠镜操作方式？" prop="item31">
                                <el-radio-group v-model="form.item31" @change="clearItem(form.item3,['item3A'],1)">
                        ...
                        <el-row>
                            <el-form-item label="2. 是否采用麻醉？" prop="item32">
                                <el-radio-group v-model="form.item32">
                                    <el-radio :label="1">1.是</el-radio>
                                    <el-radio :label="2">2.否</el-radio>
                                </el-radio-group>
                            </el-form-item>
                        ...
                        <el-row>
                            <el-form-item label="3. 肠镜到达深度？"  prop="item33">
                                <el-select v-model="form.item33" size="mini">
                        ...
                        <el-row>
                            <el-form-item label="4. 肠道准备情况？" prop="item34">
                                <el-radio-group v-model="form.item34">
                        ...
                        <el-row>
                            <el-form-item label="5. 肠镜完成时间(分钟):" prop="item35">
                                <el-input placeholder="请输入" v-model="form.item35" size="mini" style="width:160px;">
                                </el-input>
                            </el-form-item>
                        </el-row>
                        <el-row>
                        ...
                        <el-row v-if="form.item36.indexOf('3')>-1">
                            <el-form-item label="6.1. 请输入出血程度：" class="forminline" prop="item3631">
                                <el-input v-model="form.item3631"   style="width: 150px;" size="mini"></el-input>
                            </el-form-item>
                            <el-form-item label=""  prop="item3632" >
                                <span class="input-span">出血处理情况：</span>  <el-input v-model="form.item3632"  style="width: 150px;" size="mini"></el-input>
                            </el-form-item>
                        </el-row>
                        <el-row v-if="form.item36.indexOf('4')>-1">
                            <el-form-item label="6.2. 请输入其他并发症描述："  prop="item364Other" >
                            　<el-input v-model="form.item364Other"  style="width: 150px;" size="mini"></el-input>
                            </el-form-item>
                        </el-row>
                        <el-row>
                            <el-form-item label="7. 肠镜检查结果是否检出息肉？" prop="item37">
                                <el-radio-group v-model="form.item37" @change="clearItem(form.item37,['item37A'],1)">
                                    <el-radio :label="1">1.是</el-radio>
                                    <el-radio :label="2">2.否</el-radio>
                                </el-radio-group>
                            </el-form-item>
                        ...
                        <el-row>
                            <el-form-item label="7.1 检出的息肉具体数为："  prop="item37A" v-if="form.item37 == 1">
                                <el-input v-model="form.item37A"  style="width: 120px" size="mini"></el-input>
                            </el-form-item>
                        </el-row>
                        <el-row>
                            <el-form-item label="8. 是否检出除息肉外其他病变？" prop="item38">
                                <el-radio-group v-model="form.item38" @change="clearItem(form.item38,['item38A'],1)">
                                    <el-radio :label="1">1.是</el-radio>
                                    <el-radio :label="2">2.否</el-radio>
                                </el-radio-group>
                            </el-form-item>
                        ...
                        <el-row>
                            <el-form-item label="8.1 其他病变类型(请说明)："  prop="item38Other" v-if="form.item38 == 1">
                                <el-input v-model="form.item38Other"  style="width: 200px" size="mini"></el-input>
                            </el-form-item>
                        </el-row>
                        <div v-for="x,index in form.hosCjLesionsRecordInfoPOList">
                            ...
                            <div>
                                <el-row>
                                    <el-col :span="12">
                                        <el-form-item label="1. 部位:" class="formhalfline" :prop="'hosCjLesionsRecordInfoPOList.'+index+'.item1'" :rules="form.item37!=2?hosCjLesionsRecordInfoPOListRules.item1:[]">
                                            <el-select v-model="x.item1" placeholder="请选择" size="mini" :ref="'ref'+index" clearable>
                                                <el-option
                                    ...
                                    <el-col :span="12">
                                        <el-form-item label="2. 距肛(厘米):" class="formhalfline" prop="item2"  :prop="'hosCjLesionsRecordInfoPOList.'+index+'.item2'" 
                                        :rules="form.item37!=2?hosCjLesionsRecordInfoPOListRules.item2:hosCjLesionsRecordInfoPOListRules.item">
                                            <el-input placeholder="请输入" v-model="x.item2" size="mini"  style="width:160px;">
                                            </el-input>
                                        </el-form-item>
                                    </el-col>
                                </el-row>
                                <el-row>
                                    <el-col :span="12">
                                        <el-form-item label="3. 镜下考虑病变类型:" class="formhalfline" prop="item3"  :prop="'hosCjLesionsRecordInfoPOList.'+index+'.item3'" :rules="form.item37!=2?hosCjLesionsRecordInfoPOListRules.item3:[]">
                                            <el-select v-model="x.item3" placeholder="请选择"   size="mini" clearable>
                                                <el-option
                                    ...
                                    <el-col :span="12">
                                        <el-form-item label="4. 病理标本号:" class="formhalfline" prop="item4"  :prop="'hosCjLesionsRecordInfoPOList.'+index+'.item4'" :rules="form.item37!=2?hosCjLesionsRecordInfoPOListRules.item4:[]">
                                            <el-input placeholder="请输入" v-model="x.item4"  size="mini"></el-input>
                                        </el-form-item>
                                    </el-col>
                                ...
                                <el-row>
                                    <el-col :span="12">
                                        <el-form-item label="5. 最大直径(厘米):" class="formhalfline" prop="item5"  :prop="'hosCjLesionsRecordInfoPOList.'+index+'.item5'" 
                                        :rules="form.item37!=2?hosCjLesionsRecordInfoPOListRules.item5:hosCjLesionsRecordInfoPOListRules.item">
                                            <el-input placeholder="请输入" v-model="x.item5"  size="mini" style="width:160px;">
                                            </el-input>
                                        </el-form-item>
                                    </el-col>
                                    <el-col :span="12">
                                        <el-form-item label="6. 病变形状:" class="formhalfline" prop="item6"  :prop="'hosCjLesionsRecordInfoPOList.'+index+'.item6'" :rules="form.item37!=2?hosCjLesionsRecordInfoPOListRules.item6:[]">
                                ...
                                <el-row>
                                    <el-col :span="12">
                                        <el-form-item label="7. 有无蒂:" class="formhalfline" prop="item7"  :prop="'hosCjLesionsRecordInfoPOList.'+index+'.item7'" :rules="form.item37!=2?hosCjLesionsRecordInfoPOListRules.item7:[]" label-width="97px">
                                            <el-radio-group v-model="x.item7"  @change="clearItem(x.item7,x,2)">
                                    ...
                                    <el-col :span="12">
                                        <el-form-item label="7.1. 蒂形状:" class="formhalfline" prop="item8" v-if="x.item7==1"  :prop="'hosCjLesionsRecordInfoPOList.'+index+'.item8'" :rules="form.item37!=2?hosCjLesionsRecordInfoPOListRules.item8:[]">
                                ...
                                <el-row>
                                    <el-col :span="12">
                                        <el-form-item label="8. 病变颜色:" class="formhalfline" prop="item9"  :prop="'hosCjLesionsRecordInfoPOList.'+index+'.item9'" :rules="form.item37!=2?hosCjLesionsRecordInfoPOListRules.item9:[]">
                                    ...
                                    <el-col :span="12">
                                        <el-form-item label="9. 有无出血:" class="formhalfline" prop="item10"  :prop="'hosCjLesionsRecordInfoPOList.'+index+'.item10'" :rules="form.item37!=2?hosCjLesionsRecordInfoPOListRules.item10:[]">
                        ...
                        <el-row>
                            <el-form-item label="1. 其它病变:" labelWidth="100px"  prop="otherLesions" class="blockTit">
                                <el-input type="textarea"  v-model="form.otherLesions" :autosize="{minRows:3}" style="width: 100%;min-width: 500px;margin-left:25px;"></el-input>
                            </el-form-item>
                        </el-row>
                    </div>
                    ...
                    <el-row>
                        <el-form-item label="1. 内镜下诊断:" labelWidth="120px" prop="endoscopicDiagnosis" class="blockTit">
                            <el-input type="textarea" v-model="form.endoscopicDiagnosis" :autosize="{minRows:3}" style="width: 100%;min-width: 500px;margin-left:25px;"></el-input>
                        </el-form-item>
                    </el-row>
                    <el-row>
                        <el-form-item label="2. 诊断医生:" labelWidth="100px" prop="diagnosisDoctor" >
                            <el-input size="mini"  v-model="form.diagnosisDoctor"></el-input>
                        </el-form-item>
                    </el-row>
                    <el-row>
                    ...
                    <el-row>
                        <el-col :span="12">
                            <el-form-item label="填表人员:" prop="inputUser" >
                                <el-input size="mini"  v-model="form.inputUser"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
        ...
        methods: {
            ...
            submitCTResult(type){
                ...
                if(this.form.item36.indexOf('2')>-1){
                    ...
                    this.form.item362 = null
                }
                if(this.form.item36.indexOf('3')>-1){
                    this.form.item363 = 1
                }else{
                    this.form.item363 = null
                }
                if(this.form.item36.indexOf('4')>-1){
                    this.form.item364 = 1
                }else{
                    this.form.item364 = null
                }
            ...
            // 参与者是否完成了结肠镜检查选择否清空数据
            clearItem22(val){
                if(val === 2){
                    this.form.item31=null
                    this.form.item32=null
                    this.form.item33=null
                    this.form.item34=null
                    this.form.item35=null
                    this.form.item36=[]
                    this.form.item3631=null
                    this.form.item3632=null
                    this.form.item364Other=null
                    this.form.item37=null
                    this.form.item37A=null
                    this.form.item38=null
                    this.form.item38Other=null
                    this.form.otherLesions=null
                    this.form.hosCjLesionsRecordInfoPOList=[{
                        item1:'',
                        item2:'',
                        item3:'',
                        item4:'',
