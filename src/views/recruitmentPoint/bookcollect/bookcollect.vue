<template>
 <div>
     <search-com ref="bookcollect" :labelWidth="'100px'" :searchData="searchData" :formData="qc"
...
export default {
    ...
    methods: {
        exportExcel(){
            ...
            this.$axios_http({
            method:'POST',
            url:'/base/re/booking/bookingSummary/export',
            responseType:'blob',
            headers:{
        ...
        searchChange(val){
             this.qc = this.getFormData("bookcollect");
             this.qc = val;
             this.getListData();
        },
        pageSizeChange(val){
            this.queryResult.pageSize = val;
            if (this.$refs["bookcollect"]) {
              this.qc = this.$refs["bookcollect"].formData;
            }
            this.getListData();
        },
        ...
        async getListData() {
            ...
            url: "/base/re/booking/bookingSummary/query",
