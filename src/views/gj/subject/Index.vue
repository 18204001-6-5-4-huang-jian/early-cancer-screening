<template>
    <div>
        <search-com ref="3searchTable" :labelWidth="'100px'" :searchData="searchData" :formData="qc"
...
<script>
    ...
    import {SUBJECT} from '@/views/common/searchConfig3'
    ...
    export default {
        ...
        methods: {
            ...
            tableSizeChange(val) {
                ...
                if (this.$refs['3searchTable']) {
                    this.qc = this.$refs['3searchTable'].formData
                }
                this.getListData()
            },
            ...
            // 分页=>改变当前页
            tablePageChange(val) {
                this.qc = this.getFormData('3searchTable');
            ...
            getDeptree(){
                ...
                vueObj: this
                    ...
                    if(res.data.status=="SUCCESS"){
                        this.optionData=res.data.result.child
                    }
                })
            },
        }
